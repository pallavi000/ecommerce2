...
function Payment(props) {
    ...
    useEffect(() => {
        ...
        if(!props.location.query) {
            ...
            setTotal(props.location.query.total+props.location.query.fee-props.location.query.coupon_discount)
    ...
    function payment(payment_method, payment_status,amount,transaction_id,payment_type){
        const config = {
            headers: {
              Authorization: 'Bearer '+localStorage.getItem('token')
            }
        ...
        let config = {
            ...
            "eventHandler": {
                onSuccess (payload) {
                    ...
                    axios.post('/paymentverify',payload,config).then(response=>{
                        payment('khalti','done',response.data.amount,response.data.idx,response.data.type.name);
                        console.log(response.data)
...
function esewa(){
    ...
    return (
        ...
        <h5 className="card-title text-center">Payment Method</h5>
        <div class="payment-tab pt-4">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                                <span><img src={ESEWA} width="100"/></span>
                            </a>
                          </li>
                          {/* <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">
                                <span><img src={COD} width="100"/></span>
                            </a>
                          </li>
                        </ul>
                        ...
                        <div class="tab-content" id="myTabContent">
                          ...
                          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              <div class="payment-tab-content mt-3">
                                  <h4>ESEWA</h4>
                                  <p>
                                  You will be redirected to eSewa Payment page
                                  </p>
                                  <button className="btn btn-primary" onClick={()=>esewa()}>Pay Now</button>
                          ...
                          <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                              <div class="payment-tab-content mt-3">
                                  ...
                                  <button className="btn btn-primary" onClick= {()=>cod()}>Confirm Order</button>
                              </div>
                          </div>
         ...
         <div className="card-body">
          <ul className="list-group list-group-sm list-group-flush-y list-group-flush-x">
           <li className="list-group-item d-flex">
            <span>Subtotal</span> <span className="ml-auto font-size-sm">Rs.{total-fee+parseInt(coupon)}</span>
           </li>
           <li className="list-group-item d-flex">
            <span>Coupon Discount</span> <span className="ml-auto font-size-sm">Rs.{coupon}</span>
           </li>
           <li className="list-group-item d-flex">
            <span>Shipping</span> <span className="ml-auto font-size-sm">Rs.{fee}</span>
           </li>
           <li className="list-group-item d-flex font-size-lg font-weight-bold">
            <span>Total</span> <span className="ml-auto">Rs.{total}</span>
           </li>
          </ul>
         </div>
        </div>
