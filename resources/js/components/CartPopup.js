...
import TimeImg from '../../../public/assets/images/time.png'
import CashbackImg  from '../../../public/assets/images/cashback.png'
import BoxImg from '../../../public/assets/images/box.png'
import ItemImg from '../../../public/assets/images/new-item.png'
...
function CartPopup(props) {
    ...
    const[color,setColor] = useState([])
      ...
      useEffect(() => {
        $('#sec-overlay').show()
        axios.get('/detail/'+props.product_id).then(response=>{
    ...
    return (
        ...
        <div className="col-md-6">
            ...
            <h2 className="product-title text-uppercase pro">{product.name}</h2>
            {brand ?(
              ...
              <span className="product-shrt-desc pt-2 font-bold">Stock: {stock}</span>
              {product.discount ? (
                <div className="discount">
                <del>Rs.{originalPrice}</del><span className="d-inline pl-2 discount-price">{product.discount}% off</span>
            </div>
              )
            :
          (null)}
          ...
          {stock <=0 ?(
            ...
            (
                ...
                <label className="variant__label__popup">Quantity</label>
                <select className="form-control w-25" onChange={(e)=>setQuantity(e.target.value)}>
                    {
                      renderStocks(stock)
                    }
                </select>
