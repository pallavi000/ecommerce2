       ...
       return(
           ...
           <AddContextProvider>
            ...
            <Switch>
              ...
              <Route exact path="/signin/:parameter?" component={Login}/>
              ...
              <Route exact path="/track-your-order" component={OrderTracking}/>
              <Route exact path="/contact-us"component={ContactUs}/>
              <Route exact path="/about-us" component={AboutUs}/>
              <Route exact path="/terms-and-condition" component={TermssAndCondition}/>

              <Route exact path="/forgotpassword" component={Forgotpassword}/>
              <Route exact path="/setpassword/:slug"  component={SetPassword}/>


              <Route exact path="/search/:parameter?" component={Search}/>

              <Route exact path="/product-detail/:id" component={Product_detail} />
              <Route exact path="/orders/review/:id" component={OrderReview}/>
            
              <Route exact path='/signup/:parameter?' component = {SignUp}/>

              <Route exaxct path='/boutique/:slug?' component={Boutique}/>
              
              <Route exaxct path='/designer/:slug' component={Designer}/>
              <Route exact path="/order-received/:id" component={OrderReceived}/>
 
              <Route exact path="/esewaSuccess" component={EsewaSuccess}/>
              <Route exact path="/esewaFailed" component={EsewaFailed}/>
