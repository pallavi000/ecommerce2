...
function Navbar(props) {
    ...
    useEffect(() => {
      ...
      if(localStorage.getItem('token')){
        ...
        axios.get('/checkguest/'+guest_id,config).then(check=>{
        setUser(check.data)
        setIsLogedIn(true)
    ...
    useEffect(() => { 
      axios.get('/category').then(response=>{
          ...
          var mobileNav = $('<div id="mobileNav"></div>').prependTo('.offcanvas .nano .nano-content');
...
( */}
  ...
  <div class="container">
      <div class="row align-items-center">
          ...
          <a className="nav-link dropdown-toggle action-icon" href="/user" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img src={UserImg}/>
          </a>
